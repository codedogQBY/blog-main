...
import { X, Heart, MessageCircle, Flag, Trash2, Eye } from "lucide-react"
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-lg bg-white/95 dark:bg-gray-900/95 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/50 overflow-hidden max-h-[90vh] flex flex-col">
              ...
              ${theme.border}
              dark:bg-gradient-to-br dark:from-gray-800/40 dark:via-gray-700/30 dark:to-gray-800/40
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <time className="text-sm text-gray-600 dark:text-gray-300">{note.date}</time>
                                <span className="px-3 py-1 bg-white/60 dark:bg-gray-800/60 rounded-full text-xs font-medium text-gray-600 dark:text-gray-300">
                  {note.category}
                </span>
                            </div>
                    ...
                    `}
                                ...
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">{note.author}</span>
                            </div>
                        </div>
                    </div>
